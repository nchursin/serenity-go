...
func TestResultOf_BasicFunctionality(t *testing.T) {
	...
	t.Run("successful function execution", func(t *testing.T) {
		q := ResultOf("test value", func(actor core.Actor) (int, error) {
			return 42, nil
		})
	...
	t.Run("function returns error", func(t *testing.T) {
		...
		q := ResultOf("failing operation", func(actor core.Actor) (string, error) {
			return "", testErr
		})
	...
	t.Run("function with different types", func(t *testing.T) {
		// Test string result
		q1 := ResultOf("string value", func(actor core.Actor) (string, error) {
			return "hello", nil
		})
		result1, err1 := q1.AnsweredBy(actor)
		require.NoError(t, err1)
		require.Equal(t, "hello", result1)
		require.Equal(t, "string value", q1.Description())

		// Test boolean result
		q2 := ResultOf("boolean value", func(actor core.Actor) (bool, error) {
			return true, nil
		})
		result2, err2 := q2.AnsweredBy(actor)
		require.NoError(t, err2)
		require.Equal(t, true, result2)
		require.Equal(t, "boolean value", q2.Description())

		// Test float result
		q3 := ResultOf("float value", func(actor core.Actor) (float64, error) {
			return 3.14, nil
		})
		result3, err3 := q3.AnsweredBy(actor)
		require.NoError(t, err3)
		require.Equal(t, 3.14, result3)
		require.Equal(t, "float value", q3.Description())

		// Test struct result
		q4 := ResultOf("user struct", func(actor core.Actor) (TestUser, error) {
			return TestUser{Name: "John", Age: 30}, nil
		})
		result4, err4 := q4.AnsweredBy(actor)
...
func TestResultOf_ActorParameterUsage(t *testing.T) {
	...
	t.Run("function uses actor name", func(t *testing.T) {
		q := ResultOf("actor greeting", func(actor core.Actor) (string, error) {
	...
	t.Run("different actors produce different results", func(t *testing.T) {
		q := ResultOf("actor name", func(actor core.Actor) (string, error) {
		...
		result1, err1 := q.AnsweredBy(actor1)
		require.NoError(t, err1)
		require.Equal(t, "Actor1", result1)

		result2, err2 := q.AnsweredBy(actor2)
		require.NoError(t, err2)
...
func TestResultOf_ErrorHandling(t *testing.T) {
	...
	t.Run("standard error", func(t *testing.T) {
		...
		q := ResultOf("error operation", func(actor core.Actor) (int, error) {
			return 0, testErr
		})
	...
	t.Run("wrapped error", func(t *testing.T) {
		...
		q := ResultOf("wrapped operation", func(actor core.Actor) (string, error) {
			return "", wrappedErr
		})
	...
	t.Run("nil error with value", func(t *testing.T) {
		q := ResultOf("successful operation", func(actor core.Actor) (int, error) {
			return 100, nil
		})
...
func TestResultOf_ComplexOperations(t *testing.T) {
	...
	t.Run("calculations", func(t *testing.T) {
		q := ResultOf("sum calculation", func(actor core.Actor) (int, error) {
			a, b := 10, 20
			return a + b, nil
		})
	...
	t.Run("slice operations", func(t *testing.T) {
		q := ResultOf("slice processing", func(actor core.Actor) ([]int, error) {
			input := []int{1, 2, 3, 4, 5}
			var result []int
			for _, v := range input {
				if v%2 == 0 {
	...
	t.Run("map operations", func(t *testing.T) {
		q := ResultOf("map transformation", func(actor core.Actor) (map[string]int, error) {
...
func TestResultOf_DescriptionConsistency(t *testing.T) {
	...
	for _, desc := range descriptions {
		t.Run("description: "+desc, func(t *testing.T) {
			q := ResultOf(desc, func(actor core.Actor) (int, error) {
				return 1, nil
			})
...
func TestResultOf_GenericTypeInference(t *testing.T) {
	...
	t.Run("integer type inference", func(t *testing.T) {
		q := ResultOf("integer", func(actor core.Actor) (int, error) {
			return 42, nil
		})
	...
	t.Run("string type inference", func(t *testing.T) {
		q := ResultOf("string", func(actor core.Actor) (string, error) {
			return "hello", nil
		})
	...
	t.Run("pointer type inference", func(t *testing.T) {
		q := ResultOf("pointer", func(actor core.Actor) (*string, error) {
			s := "hello pointer"
			return &s, nil
		})
...
func TestResultOf_EdgeCases(t *testing.T) {
	...
	t.Run("empty description", func(t *testing.T) {
		q := ResultOf("", func(actor core.Actor) (int, error) {
			return 1, nil
		})
	...
	t.Run("nil function parameter", func(t *testing.T) {
		...
		require.Panics(t, func() {
			var nilFunc func(core.Actor) (int, error) = nil
			ResultOf("nil function", nilFunc)
		})
	})

	t.Run("function that returns nil", func(t *testing.T) {
		q := ResultOf("nil result", func(actor core.Actor) (*TestUser, error) {
			return nil, nil
		})
...
func TestResultOf_IntegrationWithQuestionInterface(t *testing.T) {
	...
	q := ResultOf("integration test", func(actor core.Actor) (int, error) {
		return 123, nil
	})
...
func TestResultOf_UsageExamples(t *testing.T) {
	...
	t.Run("computation example", func(t *testing.T) {
		...
		q := ResultOf("user age category", func(actor core.Actor) (string, error) {
			age := 25
			switch {
			case age < 18:
				return "minor", nil
	...
	t.Run("data transformation example", func(t *testing.T) {
		...
		q := ResultOf("uppercase words", func(actor core.Actor) ([]string, error) {
